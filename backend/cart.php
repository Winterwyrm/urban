...
if (isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] == true) {
  ...
  foreach ($_SESSION["cart"] as $item) {
    ...
    <div class="itemstopurchase">
      ...
      <h4>\${$item[2]}</h4>
      <p>{$item[4]}</p>
      <buttonid="open" onclick="javascript:void window.open('remove.html','1595942236492','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">Remove</button>
    </div>
    CONTENT;
  }
}
